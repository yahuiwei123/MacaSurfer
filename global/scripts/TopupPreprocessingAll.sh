...
${FSLDIR}/bin/imcp $PhaseEncodeOne ${WD}/PhaseOne.nii
${FSLDIR}/bin/imcp $PhaseEncodeTwo ${WD}/PhaseTwo.nii
${FSLDIR}/bin/imcp $ScoutInputName ${WD}/SBRef.nii
...
if [ ! $GradientDistortionCoeffs = "NONE" ] ; then
  ...
  cp ${WD}/PhaseOne.nii ${WD}/PhaseOne_gdc.nii
  cp ${WD}/PhaseTwo.nii ${WD}/PhaseTwo_gdc.nii
  fslmerge -t ${WD}/BothPhases ${WD}/PhaseOne_gdc ${WD}/PhaseTwo_gdc
  fslmaths ${WD}/PhaseOne_gdc.nii -mul 0 -add 1 ${WD}/Mask
fi
...
if [ ! $(($numslice % 2)) -eq "0" ] ; then
  ...
  for Image in ${WD}/BothPhases ${WD}/Mask ; do
    fslroi ${Image} ${WD}/slice.nii 0 -1 0 -1 0 1 0 -1
    fslmaths ${WD}/slice.nii -mul 0 ${WD}/slice.nii
    fslmerge -z ${Image} ${Image} ${WD}/slice.nii
    rm ${WD}/slice.nii
  done
fi
...
#${FSLDIR}/bin/topup --imain=${WD}/BothPhases --datain=$txtfname --config=${TopupConfig} --out=${WD}/Coefficents --iout=${WD}/Magnitudes --fout=${WD}/TopupField --dfout=${WD}/WarpField  --jacout=${WD}/Jacobian -v 
${FSLDIR}/bin/topup --imain=${WD}/BothPhases --datain=$txtfname --config=${TopupConfig} --out=${WD}/Coefficents --iout=${WD}/Magnitudes --fout=${WD}/TopupField  -v
...
#############XL, I comment all the motion correction part
# but the topup did lost head information, so I did copy params
mri_copy_params ${WD}/TopupField.nii  ${WD}/PhaseOne_gdc.nii ${WD}/TopupField.nii
...
#  ${FSLDIR}/bin/flirt -dof 6 -interp spline -in ${WD}/SBRef.nii -ref ${WD}/PhaseTwo_gdc -omat ${WD}/SBRef2PhaseTwo_gdc.mat -out ${WD}/SBRef2PhaseTwo_gdc
#  ${FSLDIR}/bin/convert_xfm -omat ${WD}/SBRef2WarpField.mat -concat ${WD}/MotionMatrix_${vnum}.mat ${WD}/SBRef2PhaseTwo_gdc.mat
#  ${FSLDIR}/bin/convertwarp --relout --rel -r ${WD}/PhaseTwo_gdc --premat=${WD}/SBRef2WarpField.mat --warp1=${WD}/WarpField_${vnum} --out=${WD}/WarpField.nii
#  ${FSLDIR}/bin/imcp ${WD}/Jacobian_${vnum}.nii ${WD}/Jacobian.nii
#  SBRefPhase=Two
## UNWARP DIR = -x,-y
...
#  ${FSLDIR}/bin/flirt -dof 6 -interp spline -in ${WD}/SBRef.nii -ref ${WD}/PhaseOne_gdc -omat ${WD}/SBRef2PhaseOne_gdc.mat -out ${WD}/SBRef2PhaseOne_gdc
#  ${FSLDIR}/bin/convert_xfm -omat ${WD}/SBRef2WarpField.mat -concat ${WD}/MotionMatrix_${vnum}.mat ${WD}/SBRef2PhaseOne_gdc.mat
#  ${FSLDIR}/bin/convertwarp --relout --rel -r ${WD}/PhaseOne_gdc --premat=${WD}/SBRef2WarpField.mat --warp1=${WD}/WarpField_${vnum} --out=${WD}/WarpField.nii
 # ${FSLDIR}/bin/imcp ${WD}/Jacobian_${vnum}.nii ${WD}/Jacobian.nii
 # SBRefPhase=One
#fi
...
#${FSLDIR}/bin/applywarp --rel --interp=spline -i ${WD}/SBRef.nii -r ${WD}/SBRef.nii -w ${WD}/WarpField.nii -o ${WD}/SBRef_dc.nii
#${FSLDIR}/bin/fslmaths ${WD}/SBRef_dc.nii -mul ${WD}/Jacobian.nii ${WD}/SBRef_dc_jac.nii

# Calculate Equivalent Field Map
${FSLDIR}/bin/fslmaths ${WD}/TopupField -mul 6.283 ${WD}/TopupField
${FSLDIR}/bin/fslmaths ${WD}/Magnitudes.nii -Tmean ${WD}/Magnitude.nii
...
if [ ! -z ${DistortionCorrectionWarpFieldOutput} ] ; then
  ${FSLDIR}/bin/imcp ${WD}/WarpField.nii ${DistortionCorrectionWarpFieldOutput}.nii
fi
if [ ! -z ${JacobianOutput} ] ; then
  ${FSLDIR}/bin/imcp ${WD}/Jacobian.nii ${JacobianOutput}.nii
fi
if [ ! -z ${DistortionCorrectionFieldOutput} ] ; then
  ${FSLDIR}/bin/imcp ${WD}/TopupField.nii ${DistortionCorrectionFieldOutput}.nii
fi
if [ ! -z ${DistortionCorrectionMagnitudeOutput} ] ; then
  ${FSLDIR}/bin/imcp ${WD}/Magnitude.nii ${DistortionCorrectionMagnitudeOutput}.nii
fi
if [ ! -z ${DistortionCorrectionMagnitudeBrainOutput} ] ; then
  ${FSLDIR}/bin/imcp ${WD}/Magnitude_brain.nii ${DistortionCorrectionMagnitudeBrainOutput}.nii
fi
