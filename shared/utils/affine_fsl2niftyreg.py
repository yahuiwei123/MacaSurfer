...
def main(args):
    ...
    tmp = mov_aff @ np.linalg.inv(S_mov) @ np.linalg.inv(fsl_aff) @ S_trg @ np.linalg.inv(trg_aff)

    aladin_aff = tmp
    
    np.savetxt(aladin_file, aladin_aff)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--aladin_mat", type=str, default='', help="ras transform mat to be generated")
