...
def estimate_bias_field(image, labels, mask, init_mean, kernel_size=(3, 3, 3), soft_kernel=0.4):
    """
    estimate bias field
    """
...
def mrf_segmentation(image_pad_array: np.ndarray,
    ...
    if refine_max_iter > 0:
        ...
        fake_bias = estimate_bias_field(image_pad_array, label_pad_array, mask_pad_array, init_mean=None, kernel_size=max_kernel, soft_kernel=1.2)
...
def main(args):
    ...
    bias, _ = fill_outside_by_nearest(bias, mask_pad, width=(7,) * 3)
