...
from nnunet.training.network_training.nnUNet_variants.data_augmentation.nnUNetTrainerV2_DA3 import nnUNetTrainerV2_DA3_BN_UNeXt,nnUNetTrainerV2_DA3_BN_UNeXt_axial_attn
...
#class nnUNetTrainerMultiHead(nnUNetTrainerV2): # Inherit default trainer class for 2D, 3D low resolution and 3D full resolution U-Net 
    ...
    def initialize_network(self):
        ...
        if self.trainer_path is None:
            ...
            #print("          self.already_trained_on:",self.already_trained_on[str("4")]['used_split'])
    ...
    def load_checkpoint_ram(self, checkpoint, train=True, network_old=False, checkpoint_old=None):
        ...
        #self.mh_network.add_n_tasks_and_activate(self.already_trained_on[str("4")]['tasks_at_time_of_checkpoint'],
                                                 #self.already_trained_on[str("4")]['active_task_at_time_of_checkpoint'])
