...
from nnunet.training.network_training.nnUNet_variants.data_augmentation.nnUNetTrainerV2_DA3 import nnUNetTrainerV2_DA3_BN_UNeXt
...
#class nnUNetTrainerMultiHead(nnUNetTrainerV2_DA3_BN_UNeXt): # Inherit default trainer class for 2D, 3D low resolution and 3D full resolution U-Net 
