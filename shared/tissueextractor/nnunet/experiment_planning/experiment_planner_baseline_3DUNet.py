    ...
    def run_preprocessing(self, num_threads):
        ...
        preprocessor = preprocessor_class(normalization_schemes, use_nonzero_mask_for_normalization,
                                         self.transpose_forward,
                                          intensityproperties)
        print("preprocessorpreprocessorpreprocessorpreprocessorpreprocessorpreprocessor",preprocessor)
        target_spacings = [i["current_spacing"] for i in self.plans_per_stage.values()]
        print("target_spacingstarget_spacingstarget_spacingstarget_spacingstarget_spacingstarget_spacingstarget_spacingstarget_spacings",target_spacings)
