...
class GenericPreprocessor(object):
    ...
    def resample_and_normalize(self, data, target_spacing, properties, seg=None, force_separate_z=None):
        ...
        # data, seg = resample_patient(data, seg, np.array(original_spacing_transposed), np.array(original_spacing_transposed),
        ...
        # properties["spacing_after_resampling"] = np.array(original_spacing_transposed)
