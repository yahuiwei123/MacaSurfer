...
from nnunet_ext.training.network_training.multihead_x.nnUNetTrainerMultiHead_x import nnUNetTrainerMultiHead_x

# -- Define globally the Hyperparameters for this trainer along with their type -- #
HYPERPARAMS = {'samples_per_ds': float}

class nnUNetTrainerRehearsal_x(nnUNetTrainerMultiHead_x):
    def __init__(self, split, task, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        if already_trained_on is not None:
            ...
            if self.already_trained_on.get(str(self.fold), None) is None:
                ...
                print(self.already_trained_on[str(self.fold)])
